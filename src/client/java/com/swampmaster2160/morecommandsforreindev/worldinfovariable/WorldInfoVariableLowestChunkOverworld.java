...
public class WorldInfoVariableLowestChunkOverworld extends WorldInfoVariableShort {
	@Override
	public short getValue(World world) {
		return world.getWorldInfo().getLowestChunkOW();
	}

	@Override
	public void setValue(World world, short value) {
		((IWorldInfo)world.worldInfo).setLowestChunkOW(value);
	}
}
